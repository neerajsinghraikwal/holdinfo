let rowsouter = document.getElementById("rowsouter");
    ...
    function appendData(data) {
      ...
      data.map((el, index) => {
        ...
        div.setAttribute("class", "titlebox rowinner");
        let td1 = document.createElement("div");
        td1.innerText = index + 1;
        td1.setAttribute("class", "indnum rowcell");
        ...
        td4.setAttribute("class", "bns rowcell");
        ...
        td6.setAttribute("class", "baseunit rowcell");
